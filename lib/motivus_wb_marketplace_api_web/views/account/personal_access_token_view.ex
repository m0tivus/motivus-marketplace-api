defmodule MotivusWbMarketplaceApiWeb.Account.PersonalAccessTokenView do
  use MotivusWbMarketplaceApiWeb, :view
  alias MotivusWbMarketplaceApiWeb.Account.PersonalAccessTokenView

  def render("index.json", %{personal_access_tokens: personal_access_tokens}) do
    %{data: render_many(personal_access_tokens, PersonalAccessTokenView, "personal_access_token.json")}
  end

  def render("show.json", %{personal_access_token: personal_access_token}) do
    %{data: render_one(personal_access_token, PersonalAccessTokenView, "personal_access_token.json")}
  end
